...
function Avatar(_a, ref) {
  ...
  var injectingClassName = Array.isArray(className) ? className : [className];
  return React__default.createElement("div", {
    className: __spreadArrays(injectingClassName, ['sendbird-avatar', isOnline ? 'sendbird-avatar--online' : '']).join(' '),
    ref: ref,
    style: {
      height: height,
      width: width
...
_ref) {
  ...
  return React__default.createElement(SubscriptionContext.Provider, {
    value: subscriptionApi
  }, React__default.createElement(StorageContext.Provider, {
...
function ChannelPreview(_ref) {
  ...
  var channelMemberIds = React.useMemo(function () {
...
var pubSubHandler$1 = function pubSubHandler(channelUrl, pubSub, dispatcher, _ref) {
    ...
    case MERGE_MESSAGES:
      {
        ...
        var lastMessage = mergedMessages.length ? mergedMessages[mergedMessages.length - 1] : null;
        return _objectSpread2({}, state, {
    ...
    case ON_MESSAGE_RECEIVED:
      {
        ...
        var _state$currentGroupCh2 = state.currentGroupChannel,
            _currentGroupChannel2 = _state$currentGroupCh2 === void 0 ? {} : _state$currentGroupCh2,
...
function OutgoingUserMessage(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_1
  }, renderMessageBody ? renderMessageBody(message, MemoizedMessageText) : React__default.createElement(MemoizedMessageText, null))), useReaction && message.reactions && message.reactions.length > 0 && React__default.createElement(EmojiReactions, {
...
function IncomingUserMessage(_ref2) {
  ...
  return React__default.createElement("div", {
  ...
  }, renderMessageAuthor ? renderMessageAuthor(message) : React__default.createElement(React__default.Fragment, null, !chainBottom && React__default.createElement(ContextMenu, {
    menuTrigger: function menuTrigger(toggleDropdown) {
      return React__default.createElement(Avatar$1, {
        ref: avatarRef,
        onClick: function onClick() {
    ...
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_1
  }, renderMessageBody ? renderMessageBody(message, MemoizedMessageText) : React__default.createElement(MemoizedMessageText, null))), showEmojiReactions && React__default.createElement(EmojiReactions, {
    className: "sendbird-user-message__text-balloon__inner__emoji-reactions",
    userId: userId,
    message: message,
    emojiAllMap: emojiAllMap,
...
function OutgoingOGMessage(props) {
  ...
  }, renderMessageBody ? renderMessageBody(message, MemoizedMessageText) : React__default.createElement(MemoizedMessageText, null)), React__default.createElement("div", {
...
function ChatHeader(props) {
  ...
  return React__default.createElement("div", {
    ...
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_2
  }, subTitle || externalProfiles.length === 1 && externalProfiles[0].online && 'Online' || externalProfiles.length === 1 && externalProfiles[0].lastOnline && prettyDate(externalProfiles[0].lastOnline) || React__default.createElement(AutoRefresh, {
...
var ConversationPanel = function ConversationPanel(props) {
  ...
  }, [channelUrl, sdkInit, scrollToBottom]); // to create initial read status
