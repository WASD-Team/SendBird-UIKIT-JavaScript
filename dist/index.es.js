...
function OutgoingUserMessage(_ref) {
  ...
  return React.createElement("div", {
    ...
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_1
  }, renderMessageBody ? renderMessageBody(message, MemoizedMessageText) : React.createElement(MemoizedMessageText, null))), useReaction && message.reactions && message.reactions.length > 0 && React.createElement(EmojiReactions, {
...
function IncomingUserMessage(_ref2) {
  ...
  return React.createElement("div", {
  ...
  }, renderMessageAuthor ? renderMessageAuthor(message) : React.createElement(React.Fragment, null, !chainBottom && React.createElement(ContextMenu, {
    menuTrigger: function menuTrigger(toggleDropdown) {
      return React.createElement(Avatar$1, {
        ref: avatarRef,
        onClick: function onClick() {
    ...
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_1
  }, renderMessageBody ? renderMessageBody(message, MemoizedMessageText) : React.createElement(MemoizedMessageText, null))), showEmojiReactions && React.createElement(EmojiReactions, {
    className: "sendbird-user-message__text-balloon__inner__emoji-reactions",
    userId: userId,
    message: message,
    emojiAllMap: emojiAllMap,
...
function OutgoingOGMessage(props) {
  ...
  }, renderMessageBody ? renderMessageBody(message, MemoizedMessageText) : React.createElement(MemoizedMessageText, null)), React.createElement("div", {
