...
function Sendbird(props) {
  ...
  var localeStringSet = React.useMemo(
    function() {
      if (!stringSet) {
...
function UserListItem(_ref) {
  ...
  return React.createElement(
    ...
    user.isMuted &&
      React.createElement(MutedAvatarOverlay, {
        height: 40,
        width: 40
      }),
...
function ChannelList(props) {
  ...
  var allChannelsMemberIds = useMemo(
    function() {
      if (!allChannels) {
        return [];
      }
  ...
  return React.createElement(
    ...
    showProfileEdit &&
      React.createElement(ConnectedEditUserProfile, {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              renderMessageBody
                ...
                : React.createElement(MemoizedMessageText, null)
            )
          ),
          useReaction &&
            message.reactions &&
...
function ThumbnailMessage(_ref) {
  ...
  return isByMe
    ? React.createElement(OutgoingThumbnailMessage, {
        userId: userId,
        status: status,
        message: message,
        onClick: onClick,
...
function UnknownMessage(_ref) {
  ...
  return React.createElement(
    ...
    isByMe
      ? React.createElement(OutgoingUnknownMessage, {
          status: status,
          message: message,
          chainTop: chainTop,
          showRemove: showRemove,
...
var OGMessageSwitch = function OGMessageSwitch(_ref) {
  ...
  return React.createElement(
    ...
    isByMe
      ? React.createElement(OutgoingOGMessage, {
          status: status,
          userId: userId,
          message: message,
          disabled: disabled,
        ...
        React.createElement(
          ...
          defaultImage &&
            React.createElement(ImageRenderer, {
              ...
              width: "320px",
              height: "180px",
              defaultComponent: React.createElement(
                "div",
                {
                  className: "".concat(
                    OUTGOING_OG_MESSAGE,
...
function MessageHoc(_ref) {
  ...
  return React.createElement(
    ...
    _defineProperty(
      _MessageTypes$ADMIN$M,
      MessageTypes.OG,
      React.createElement(OGMessageSwitch, {
        message: message,
        status: status,
        isByMe: isByMe,
        userId: userId,
    ...
    !(
      ...
      !showFileViewer &&
      React.createElement(UnknownMessage, {
        message: message,
        status: status,
        isByMe: isByMe,
        showRemove: setShowRemove,
...
var ConversationPanel = function ConversationPanel(props) {
  ...
  var scrollToBottom = useCallback(
    function() {
  ...
  return React.createElement(
    ...
    isFrozen && React.createElement(FrozenNotification, null),
    unreadCount > 0 &&
...
var MemebersAccordion = function MemebersAccordion(_ref2) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      members.length >= SHOWN_MEMBER_MAX &&
        showMoreModal &&
        React.createElement(MembersModal, {
          currentUser: currentUser,
...
var UserListItem$2 = function UserListItem(_a) {
  ...
  return React.createElement(
    ...
    user.isMuted && React.createElement(MutedAvatarOverlay, null),
    React.createElement(ContextMenu, {
      menuTrigger: function menuTrigger(toggleDropdown) {
        return React.createElement(Avatar$1, {
          onClick: function onClick() {
...
var OperatorList = function OperatorList(_a) {
  ...
  return React.createElement(
    ...
    showMore &&
      React.createElement(OperatorsModal, {
        currentUser: sdk.currentUser.userId,
        hideModal: function hideModal() {
          setShowMore(false);
          refershList();
    ...
    showAdd &&
      React.createElement(AddOperatorsModal, {
        hideModal: function hideModal() {
...
var MemberList = function MemberList(_a) {
  ...
  return React.createElement(
    ...
    showInviteMembers &&
      React.createElement(InviteMembers$1, {
        userQueryCreator: userQueryCreator,
...
var BannedMemberList = function BannedMemberList(_a) {
  ...
  return React.createElement(
    ...
    showModal &&
      React.createElement(BannedMembersModal, {
        channel: channel,
        hideModal: function hideModal() {
          setShowModal(false);
          refreshList();
...
var MutedMemberList = function MutedMemberList(_a) {
  ...
  return React.createElement(
    ...
    showModal &&
      React.createElement(MutedMembersModal, {
        currentUser: sdk.currentUser.userId,
        channel: channel,
        hideModal: function hideModal() {
          setShowModal(false);
    ...
    React.createElement(Accordion, {
      ...
      renderContent: function renderContent() {
        return React.createElement(
          React.Fragment,
          null,
          React.createElement(OperatorList$1, {
            channel: channel
          })
        );
      }
    ...
    React.createElement(Accordion, {
      ...
      renderContent: function renderContent() {
        return React.createElement(
          React.Fragment,
          null,
          React.createElement(MemberList$1, {
            userQueryCreator: userQueryCreator,
            channel: channel
          })
        );
      ...
      React.createElement(Accordion, {
        ...
        renderContent: function renderContent() {
          return React.createElement(
            React.Fragment,
            null,
            React.createElement(MutedMemberList$1, {
              channel: channel
            })
          );
        }
    ...
    React.createElement(Accordion, {
      ...
      renderContent: function renderContent() {
        return React.createElement(
          React.Fragment,
          null,
          React.createElement(BannedMemberList$1, {
            channel: channel
          })
        );
      }
    ...
    React.createElement(
      ...
      channel.myRole === "operator"
        ...
        : React.createElement(
            ...
            showAccordion &&
              React.createElement(MemebersAccordion, {
                currentUser: userId,
...
export {
  ...
  ChannelList$1 as ChannelList,
  ChannelSettings$1 as ChannelSettings,
  ExternalUserProfileProvider,
  MessageHoc,
  Sendbird as SendBirdProvider,
  getAllEmojisFromEmojiContainer$1 as getAllEmojisFromEmojiContainer,
  getEmojiCategoriesFromEmojiContainer$1 as getEmojiCategoriesFromEmojiContainer,
  getEmojisFromEmojiContainer$1 as getEmojisFromEmojiContainer,
  getStringSet,
  selectors as sendBirdSelectors,
  useSendBirdContext as useSendBird,
